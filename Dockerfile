...
# Apuntamos a la ruta absoluta del archivo de configuración
CMD ["gunicorn", "--bind", "0.0.0.0:5000", "--log-level", "info", "--access-logfile", "-", "--error-logfile", "-", "--logger-class", "gunicorn.glogging.Logger", "app:app"]